...
var item = {
    ...
    deleteItem: function () { },
    performWorkflowTransition: function (transID, comment) { },
    /**
     ...
     */
    grid: {
        addRows: function (PHASE, STATUS) { }, //TASK_START: Date, TASK_END: Date, ASSIGNED_DEPARTMENT: string, ASSIGNED_USER: string, DETAILS: string) { },
        /**
         * ### `item.grid.clear()`
